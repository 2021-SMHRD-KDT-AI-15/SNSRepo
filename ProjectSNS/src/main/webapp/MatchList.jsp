      ...
      c5.5,0,9.9,4.5,9.9,9.9V73.3z"></path></svg></span>
			...
			<div
				...
				<div class="u-clearfix u-sheet u-sheet-2">
					...
					<a href="https://nicepage.com/c/tiles-website-templates"
						class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-2">Button</a>
					<a href="https://nicepage.com/c/tiles-website-templates"
						class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-3">Button</a>
					<a href="https://nicepage.com/c/tiles-website-templates"
						class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-4">Button</a>
					<a href="https://nicepage.com/c/tiles-website-templates"
						class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-5">Button</a>
				</div>
			</div>
		</div>
	</header>
		...
		<div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
			...
			<div class="u-expanded-width u-layout-horizontal u-list u-list-1">
				<div class="u-repeater u-repeater-1">
					<div
						class="u-align-left u-border-2 u-border-custom-color-3 u-container-style u-list-item u-repeater-item">
						<div
							class="u-container-layout u-similar-container u-container-layout-1">
							<div class="u-expanded-width u-image u-image-circle u-image-1"
								alt="" data-image-width="1280" data-image-height="853"></div>
							<h4 class="u-align-center u-text u-text-2">팀예시1</h4>
							<p class="u-text u-text-3">
								팀간단한 설명<br>우리는 런닝을한다<br>런닝이 좋다<br>런닝 좋아<br>런닝<br>런
							</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<div class="u-expanded-width u-image u-image-circle u-image-2"
								alt="" data-image-width="1280" data-image-height="790"></div>
							<h4 class="u-align-center u-text u-text-4">팀예시2</h4>
							<p class="u-text u-text-5">
								우리는 춤춘다<br>우리는 춤을 엄청 춘다<br>우리는 춤을 정말 좋아한다<br>춤추자
								춤춤추뭋무
							</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<div class="u-expanded-width u-image u-image-circle u-image-3"
								alt="" data-image-width="1280" data-image-height="850"></div>
							<h4 class="u-align-center u-text u-text-6">팀예시3</h4>
							<p class="u-text u-text-7">
								우리는 농구한다<br>우리는 농구를 엄청한다<br>농구좋아 좋아 좋아<br>농구할래할래할래?????
							</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<img class="u-expanded-width u-image u-image-default u-image-4"
								alt="" data-image-width="2836" data-image-height="1875"
								src="images/90fc53c9.svg">
							<h4 class="u-align-center u-text u-text-8">Sample Headline</h4>
							<p class="u-text u-text-9">Sample text. Click to select the
					...
					<div
						...
						<div
							...
							<p class="u-text u-text-11">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<p class="u-text u-text-13">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<p class="u-text u-text-15">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<p class="u-text u-text-17">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<p class="u-text u-text-19">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<p class="u-text u-text-21">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<p class="u-text u-text-23">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<p class="u-text u-text-25">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<p class="u-text u-text-27">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<p class="u-text u-text-29">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<p class="u-text u-text-31">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<p class="u-text u-text-33">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<img class="u-expanded-width u-image u-image-default u-image-17"
								alt="" data-image-width="2836" data-image-height="1875"
								src="images/90fc53c9.svg">
							<h4 class="u-align-center u-text u-text-34">Sample Headline</h4>
							<p class="u-text u-text-35">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<img class="u-expanded-width u-image u-image-default u-image-18"
								alt="" data-image-width="2836" data-image-height="1875"
								src="images/90fc53c9.svg">
							<h4 class="u-align-center u-text u-text-36">Sample Headline</h4>
							<p class="u-text u-text-37">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<img class="u-expanded-width u-image u-image-default u-image-19"
								alt="" data-image-width="2836" data-image-height="1875"
								src="images/90fc53c9.svg">
							<h4 class="u-align-center u-text u-text-38">Sample Headline</h4>
							<p class="u-text u-text-39">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<img class="u-expanded-width u-image u-image-default u-image-20"
								alt="" data-image-width="2836" data-image-height="1875"
								src="images/90fc53c9.svg">
							<h4 class="u-align-center u-text u-text-40">Sample Headline</h4>
							<p class="u-text u-text-41">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
					<div
						...
						<div
							...
							<img class="u-expanded-width u-image u-image-default u-image-21"
								alt="" data-image-width="2836" data-image-height="1875"
								src="images/90fc53c9.svg">
							<h4 class="u-align-center u-text u-text-42">Sample Headline</h4>
							<p class="u-text u-text-43">Sample text. Click to select the
								text box. Click again or double click to start editing the text.</p>
						</div>
					</div>
				</div>
