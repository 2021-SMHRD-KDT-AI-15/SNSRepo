...
<link rel="stylesheet" href="ChatRoomList.css" media="screen">
...
<meta name="twitter:title" content="ChatRoomList">
<meta name="twitter:description" content="">
<meta property="og:title" content="ChatRoomList">
		...
		<div class="u-section-rows" style="margin-bottom: 0px;">
				...
				<div class="u-clearfix u-sheet u-sheet-1">
					<div class="u-social-icons u-spacing-10 u-social-icons-1">
						...
						<span class="u-icon u-social-facebook u-social-icon u-icon-1">
							<svg class="u-svg-link" preserveAspectRatio="xMidYMin slice"viewBox="0 0 112 112" style="">
								<use xmlns:xlink="http://www.w3.org/1999/xlink"xlink:href="#svg-96b6"></use>
							</svg>
							<svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0"id="svg-96b6">
						...
						<a class="u-social-url" title="twitter" target="_blank"href="https://twitter.com/name">
							<span class="u-icon u-social-icon u-social-twitter u-icon-2">
								<svg class="u-svg-link" preserveAspectRatio="xMidYMin slice"viewBox="0 0 112 112" style="">
									<use xmlns:xlink="http://www.w3.org/1999/xlink"xlink:href="#svg-1640"></use>
								</svg>
								<svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0"id="svg-1640">
						...
						<a class="u-social-url" title="instagram" target="_blank"href="https://www.instagram.com/name">
							<span class="u-icon u-social-icon u-social-instagram u-icon-3">
								<svg class="u-svg-link" preserveAspectRatio="xMidYMin slice"viewBox="0 0 112 112" style="">
									<use xmlns:xlink="http://www.w3.org/1999/xlink"xlink:href="#svg-ad97"></use>
								</svg>
								<svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0"id="svg-ad97">
									<circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
									<path fill="#FFFFFF"
					...
					<form action="#" method="get" class="custom-expanded u-border-1 u-border-black u-radius u-search u-search-right u-search-1">
						...
						<span class="u-search-icon u-spacing-10 u-text-black"> 
								...
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="svg-9dab" x="0px" y="0px" 
								viewBox="0 0 56.966 56.966" style="enable-background: new 0 0 56.966 56.966;" xml:space="preserve" class="u-svg-content">
									<path d="M55.146,51.887L41.588,37.786c3.486-4.144,5.396-9.358,5.396-14.786c0-12.682-10.318-23-23-23s-23,10.318-23,23  s10.
									318,23,23,23c4.761,0,9.298-1.436,13.177-4.162l13.661,14.208c0.571,0.593,1.339,0.92,2.162,0.92
			...
			<div class="u-border-5 u-border-custom-color-2 u-border-no-left u-border-no-right u-border-no-top u-section-row u-sticky u-sticky-5c67 u-white u-section-row-2" id="sec-37e8">
				<div class="u-clearfix u-sheet u-sheet-2">
					...
					<a href="BoardDetail" class=" u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-2"><img src="images/home.png" style="width:25px"></a> 
					<a href="FriendListService" class=" u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-3"><img src="images/group.png" style="width:25px"></a> 
					<a href="MatchMain.jsp" class=" u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-4"><img src="images/matching.png" style="width:25px"></a> 
					<a href="map.jsp" class=" u-border-black u-btn u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-5">
					<img src="images/map.png" style="width:25px"></a>
				</div>
			</div>
		</div>
	</header>
			...
			<div class="scroll u-expanded-width u-table u-table-responsive u-table-1">
				<table class="u-table-entity">
					<tbody class="u-align-center u-table-body">
						<c:forEach var="chat_room_list" items="${chat_room_list}">
							<tr style="height: 100px;">
								<td class="u-align-center u-border-2 u-border-grey-30 u-first-column u-table-cell u-table-cell-6">${chat_room_list.title}</td>
								<td class="u-border-2 u-border-grey-30 u-table-cell">
									<form action="#">
										<input type="hidden" name="id" value=${chat_room_list.chat_id}>
