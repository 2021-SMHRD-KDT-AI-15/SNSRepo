...
#category li .category_bg {
	background: url(./img/kakao_marker.png) no-repeat;
}
...
<body data-path-to-root="./" data-include-products="false"
	...
	<section class="u-clearfix u-container-align-center u-section-1"
		...
		<div class="u-clearfix u-sheet u-sheet-1">
			<p
				class="u-align-center u-custom-font u-text u-text-default u-text-1">Map</p>
			<div
				class="u-container-style u-expanded-width u-group u-palette-1-base u-group-1"
				style="height: 600px;">
				<div class="u-container-layout u-container-layout-1">
					<div class="map_wrap" style="color: black;">
						...
						<ul id="category">
							...
							<li id="FD6" data-order="3"><span class="category_bg oil"></span>
								식당</li>
	...
	<section class="u-backlink u-clearfix u-grey-80">
		...
		<a class="u-link" href="" target="_blank"> <span>Offline
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=5f8631d290610c170d36d52522dbb62a&libraries=services"></script>
	<script>
		// 세션 값 가져오기
		...
		function searchOverlayPlaces() {
			...
			psOverlay.categorySearch(currCategory, overlayPlacesSearchCB, {
				useMapBounds : true
			});
		}
		...
		function displayOverlayPlaces(places) {
			...
			for (var i = 0; i < places.length; i++) {
				...
				// 마커를 생성하고 지도에 표시합니다
				var marker = addRedMarker(new kakao.maps.LatLng(places[i].y,
						places[i].x), order);
