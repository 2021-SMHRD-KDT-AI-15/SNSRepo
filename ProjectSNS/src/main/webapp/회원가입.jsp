...
<link rel="stylesheet" href="회원가입.css" media="screen">
    ...
    <meta name="twitter:title" content="회원가입">
          ...
          <div class="u-container-layout u-container-layout-6">
            ...
            <div class="u-clearfix u-custom-html u-expanded-width u-custom-html-1">
                ...
                <div class="u-form-group u-form-name">
                  <label for="name-573f" class="u-custom-font u-label u-label-1">ID</label>
                  <input type="text" id="name-573f" name="Member_id" class="u-input u-input-rectangle" required="" placeholder="아이디를 입력해주세요">
                </div>
                <div class="u-form-email u-form-group">
                  <label for="email-573f" class="u-custom-font u-label u-label-2">Password</label>
                  <input type="password" placeholder="비밀번호를 입력해주세요" id="email-573f" name="pw" class="u-input u-input-rectangle" required="">
                </div>
                <div class="u-form-group u-form-group-3">
                  <label for="text-51ac" class="u-custom-font u-label u-label-3">Password 확인</label>
                  <input type="password" placeholder="비밀번호를 입력해주세요" id="text-51ac" name="text" class="u-input u-input-rectangle">
                </div>
                <div class="u-form-group u-form-group-4">
                  <label for="text-b72b" class="u-custom-font u-label u-label-4">Name</label>
                  <input type="text" placeholder="이름을 입력해주세요" id="text-b72b" name="name" class="u-input u-input-rectangle">
                </div>
                <div class="u-form-email u-form-group u-form-group-5">
                  <label for="email-f022" class="u-custom-font u-label u-label-5">Email</label>
                  <input type="email" placeholder="Email을 입력해주세요" id="email-f022" name="mail" class="u-input u-input-rectangle" required="">
                </div>
                <div class="u-form-email u-form">
				<label for="email-573f" class="u-custom-font u-label u-label-2">생년월일</label>
				<input type="text" placeholder="YYYY/MM/DD형식으로 입력해주세요" id="email-573f" name="birth" class="u-input u-input-rectangle" required="">
         	   </div>
                <div class="u-form-group u-form-group-7 u-form-input-layout-horizontal u-form-radiobutton">
                  <label class="u-custom-font u-label u-label-7">성별</label>
                  <div class="u-form-radio-button-wrapper">
                    <div class="u-input-row">
                      <input id="field-aeb6" type="radio" name="gender" value="남성" class="u-field-input" checked="checked" style="" data-calc="">
                      <label class="u-field-label" for="field-aeb6">남성</label>
                    </div>
                    <div class="u-input-row">
                      <input id="field-fb1a" type="radio" name="gender" value="여성" class="u-field-input" style="" data-calc="">
                      <label class="u-field-label" for="field-fb1a">여성</label>
                    </div>
                  </div>
                </div>
                    <div class="u-form-email u-form">
				<label for="email-573f" class="u-custom-font u-label u-label-2">Rating</label>
				<input type="text" placeholder="레이팅점수입력" id="email-573f" name="rating_person" class="u-input u-input-rectangle" required="">
         	   </div>
         	    <div class="u-form-email u-form">
				<label for="email-573f" class="u-custom-font u-label u-label-2">Location</label>
				<input type="text" placeholder="개인정보에 저장할 지역을 입력해주세요" id="email-573f" name="location" class="u-input u-input-rectangle" required="">
         	   </div>
                <div class="u-form-group u-form-group-9 u-form-textarea">
                  <label for="textarea-41f3" class="u-custom-font u-label u-label-9">자기소개</label>
                  <textarea rows="4" cols="50" id="textarea-41f3" name="dis" class="u-input u-input-rectangle" required=""></textarea>
                </div>
                <input type="submit">
