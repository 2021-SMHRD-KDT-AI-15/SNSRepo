...
<link rel="stylesheet" href="Join.css" media="screen">
  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en"><header class="u-align-left u-clearfix u-header u-section-row-container" id="sec-0c53"><div class="u-section-rows" style="margin-bottom: 0px;">
                ...
                <div class="u-form-group u-form-group-7 u-form-input-layout-horizontal u-form-radiobutton">
                  ...
                  <div class="u-form-radio-button-wrapper">
                    <div class="u-input-row">
                      <input id="field-aeb6" type="radio" name="gender" value="남" class="u-field-input" checked="checked" style="" data-calc="">
                      <label class="u-field-label" for="field-aeb6">남성</label>
                    </div>
                    <div class="u-input-row">
                      <input id="field-fb1a" type="radio" name="gender" value="여" class="u-field-input" style="" data-calc="">
    ...
    <input type="submit" value="회원가입" style="display: block; margin-top: 5px; border: 2px solid #fe7054; padding: 8px 12px; background-color: white; text-align: center;">
</div>
