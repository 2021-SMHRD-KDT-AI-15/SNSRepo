				...
				<div class="u-repeater u-repeater-1">
					...
					<div
						...
						<div
							...
							<a href="https://nicepage.com/joomla-templates"
								class="u-border-none u-btn u-btn-round u-button-style u-custom-color-2 u-custom-item u-hover-custom-color-4 u-radius u-btn-2">트렌딩</a>
						</div>
					</div>
					<div
						class="u-container-style u-list-item u-repeater-item u-shape-rectangle">
						<div
							...
							<a href="https://nicepage.com/joomla-templates"
								class="u-border-none u-btn u-btn-round u-button-style u-custom-color-2 u-custom-item u-hover-custom-color-4 u-radius u-btn-3">친구/그룹</a>
						</div>
					</div>
					<div
						class="u-container-style u-list-item u-repeater-item u-shape-rectangle">
						<div
							...
							<a href="https://nicepage.com/joomla-templates"
								class="u-border-none u-btn u-btn-round u-button-style u-custom-color-2 u-custom-item u-hover-custom-color-4 u-radius u-btn-4">종목별</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div>
						<form action="commentDetail" method="post"
							...
							<div style="display: inline-block; text-align: left;">
								...
								<input type="text" name="comment_id"><br> <input
									type="text" name="p_comment"><br>
								<div style="text-align: center;">
