...
<link rel="stylesheet" href="FriendList.css" media="screen">
...
<meta name="twitter:title" content="FriendList">
<meta name="twitter:description" content="">
<meta property="og:title" content="FriendList">
...
<body data-path-to-root="./" data-include-products="false"
	...
	<header
      ...
      c5.5,0,9.9,4.5,9.9,9.9V73.3z"></path></svg></span>
					...
					<form action="#" method="get"
						...
						<input class="u-custom-font u-heading-font u-search-input u-text-black u-search-input-1"
			...
			<div class="u-border-5 u-border-custom-color-2 u-border-no-left u-border-no-right u-border-no-top u-section-row u-sticky u-sticky-5c67 u-white u-section-row-2"
				id="sec-37e8">
	...
	<section class="scroll u-clearfix u-white u-section-1" id="sec-3939">
		<div class="u-clearfix u-sheet u-sheet-1">
			<a href="FriendListService" class="u-border-none u-btn u-button-style u-custom-color-3 u-btn-1">
				친구 목록</a> 
				<a href="GroupListService" class="u-border-none u-btn u-button-style u-custom-color-3 u-btn-2">
				그룹 목록</a> 
				<a href="" class="u-border-none u-btn u-button-style u-custom-color-3 u-btn-3">
				친구 추가</a>
				
			<div class="u-border-3 u-border-custom-color-3 u-line u-line-horizontal u-line-1"></div>
			<div class="u-expanded-width u-list u-list-1">
				<div class="u-repeater u-repeater-1">
					<c:forEach var="friend_list" items="${friend_list}">
						<div
							class="u-border-2 u-border-custom-color-3 u-container-style u-gradient u-list-item u-repeater-item u-video-cover u-list-item-2">
							<div
								class="u-container-layout u-similar-container u-valign-top u-container-layout-2">
								<h3 class="u-align-center u-text u-text-default u-text-3">${friend_list.name}</h3>
								<div
									class="u-border-4 u-border-custom-color-3 u-expanded-width u-line u-line-horizontal u-line-3"></div>
								<div alt=""
									class="u-expanded-width u-image u-image-circle u-image-2"
									data-image-width="1280" data-image-height="850"></div>
								<p class="u-align-center u-text u-text-default u-text-4">${friend_list.dis}</p>
								<form action="FriendDeleteService">
									<input type="hidden" name="friend_id"
										value=${friend_list.member_id}> <input
										class="u-border-none u-btn u-button-style u-custom-color-3 u-btn-5"
